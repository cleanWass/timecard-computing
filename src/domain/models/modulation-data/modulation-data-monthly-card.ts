...
export class ModulationDataMonthlyCard implements ValueObject {
  ...
  public static build({
    ...
    return new ModulationDataMonthlyCard(
      `${ModulationDataMonthlyCard.count++}`,
      employee,
      week,
      workingPeriods,
      employmentContracts,
  ...
  private constructor(
    public readonly id: ModulationDataMonthlyCardId,
  ...
  equals(other: unknown): boolean {
    return this._vo.equals((other as ModulationDataMonthlyCard)?._vo);
  }
  ...
  debug(full = false): string {
    return `ModulationDataMonthlyCard # ${this.id}
  ...
  with(params: Partial<ModulationDataMonthlyCard>): ModulationDataMonthlyCard {
    return new ModulationDataMonthlyCard(
      params.id ?? this.id,
