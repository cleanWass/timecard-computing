...
export type ExtractEitherRightType<A extends (...args: unknown[]) => unknown> = ReturnType<A> extends Either<any, infer B> ? B : never;
...
export type TypeProps<Type> = Type[keyof Type];
